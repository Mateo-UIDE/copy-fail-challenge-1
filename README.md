...
HITO 1:
Se ejecuto el script en el directorio del usuario (~/) para evadir la falta de permisos en /tmp, copiando luego el reporte impreso desde la VM y pegándolo directamente en el host (Codespaces) mediante nano para generar el archivo de evidencia final listo para Git.